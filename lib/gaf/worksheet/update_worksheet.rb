require_relative "load_worksheet"

module Gaf
  module Worksheet
    class UpdateWorksheet
      include LoadWorksheet
      ...
      private
      attr_reader :branch, :pull_request_link, :sprint, :user, :params, :array_main_branchs, :worksheet, :hash_row_title, :sprint
      def pull_request?
